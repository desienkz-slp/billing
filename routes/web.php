...
Route::middleware(['auth', 'tenant'])->group(function () {
    ...
    // Keuangan (Finance)
    Route::get('reports/expenses', [ExpenseController::class, 'index'])->middleware('permission:can_view_finance,can_view_menu_expenses')->name('reports.expenses.index');
    Route::post('reports/expenses', [ExpenseController::class, 'store'])->middleware('permission:can_manage_expenses')->name('reports.expenses.store');
    ...
    Route::get('/cust/cuti', [CutiController::class, 'index'])
        ->middleware('permission:can_manage_cuti,can_view_menu_pelanggan_cuti')->name('cust.cuti.index');
    ...
    Route::prefix('cust')->name('cust.')->group(function () {
        Route::get('/isolir', [IsolirController::class, 'index'])
            ->middleware('permission:can_manage_isolir,can_view_menu_isolir')->name('isolir.index');
    ...
    Route::get('/sales/setoran', [ReportController::class, 'setoran'])
        ->middleware('permission:can_manage_deposits,can_view_menu_setoran')->name('sales.setoran');
    ...
    Route::get('/sales/mitra', [ReportController::class, 'mitra'])
        ->middleware('permission:can_view_finance,can_view_menu_mitra')->name('sales.mitra');
    Route::get('/sales/mitra/{user}/deposits', [ReportController::class, 'mitraDeposits'])
        ->middleware('permission:can_view_finance,can_view_menu_mitra')->name('sales.mitra.deposits');
    Route::get('/sales/saldo', [ReportController::class, 'saldo'])
        ->middleware('permission:can_view_finance,can_view_menu_saldo')->name('sales.saldo');
    ...
    Route::get('/sales/saldo/{user}/history', [ReportController::class, 'saldoHistory'])
        ->middleware('permission:can_view_finance,can_view_menu_saldo')->name('sales.saldo.history');
