...
/*   __________________________________________________
    ...
    |__________________________________________________|
*/
 use Illuminate\Database\Migrations\Migration; use Illuminate\Database\Schema\Blueprint; use Illuminate\Support\Facades\Schema; return new class extends Migration { public function up(): void { Schema::table('roles', function (Blueprint $EUOFn) { $EUOFn->boolean('can_send_wa_invoice')->default(false)->after('can_process_payment'); }); } public function down(): void { Schema::table('roles', function (Blueprint $EUOFn) { $EUOFn->dropColumn('can_send_wa_invoice'); }); } };
